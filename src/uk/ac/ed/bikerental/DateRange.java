...
public class DateRange {
    ...
    /** Calculates the number of years between the start and end date of the date range.
     * That is, it converts the size of the date range into years. 
     * @return A long representing the number of years between the start and end dates. 
     */
    ...
    /** Calculates the number of days between the start and end date of the date range.
     * That is, it converts the size of the date range into days. 
     * @return A long representing the number of days between the start and end dates. 
     */
    ...
    /** This method is used to check whether or not two date ranges overlap.
     * It does this by checking four conditions which represent all possible ways 2 dates can overlap.
     ...
     * @return int Represents the hash code value for the object on which hashCode() is invoked.
     */
    ...
    /** This method checks if some other Object passed to it as an argument is equal to 
        the Object on which it is invoked. This provides a deep comparison of the two objects.
     * @param obj The Object to which we are comparing to Object which calls the equals() method.
     * @return boolean Represents whether or not the two objects are equal. Returns true if
