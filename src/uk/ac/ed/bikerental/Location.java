...
public class Location {
    ...
    /** Creates an instance of Location class with strings that represent the postcode and address of the Location. 
     * 
    ...
    /** This method checks if some other Location passed to it as an argument is near to to the Location
     * on which it is invoked.The way it does this is by checking if the first two characters of the 
     * postcode attribute of both classes is the same. If it is then they are near each other and the
     * method returns true. Otherwise it returns false.
     * 
     * @param other The Location to which we are comparing to the Location that calls the equals() method.
     * @return boolean A boolean value representing whether or not the two addresses are near each other.
