...
public class BikeRentalSystem {
    ...
    public Booking bookQuote(Quote quote, String firstName, String lastName, String address, String postCode, String phoneNumber,
            String email, String password, boolean storeCollection) {
        return this.bookQuote(quote, new Customer(firstName, lastName, address, postCode, phoneNumber,
             email, password), storeCollection);
    }
    ...
    /**
     * Method resets state of the system for JUnit testing. Use ONLY for testing purposes.
     * 
     */
