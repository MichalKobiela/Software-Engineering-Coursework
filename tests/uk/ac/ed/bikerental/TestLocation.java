...
class TestLocation {
    ...
    void testIsNearTo() {
        ...
        assertEquals(false, this.location1.isNearTo(location2), "First two chars of postcode are NOT equal so are NOT near");
        assertEquals(false, this.location3.isNearTo(location4), "First two chars of postcode are NOT equal so are NOT near");
